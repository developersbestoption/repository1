...
$sql = "INSERT INTO register (name,gender,dateofbirth,bloodgroup, placeofbirth, mothertongue, caste, religion, nationality, aadhar,contact,moles,emailid,sschallticket,sscboard,sscgpa,yearofpassing,sscschool,passtype) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

// Prepare and bind the statement
$stmt = $connection->prepare($sql);
$stmt->bind_param("ssssssssisissssssss",$name, $gender, $dob, $bloodgroup, $pob, $mothertongue, $caste, $religion, $nationality, $aadhar,$contact,$mole,$email,$scchall,$sscboard,$sscgpa,$yearofpassing,$sscschoolname,$passtype);
